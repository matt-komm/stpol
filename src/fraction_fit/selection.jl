...
selections = {
    :mu => :((lepton_type .== 13) .* (n_signal_mu .== 1) .* (n_signal_ele .== 0) .* (n_veto_mu .== 0) .* (n_veto_ele .== 0)),
    :ele => :(lepton_type .== 11),
...
function perform_selection(indata)
    inds = {
        :mu => (indata["lepton_type"] .== 13) .* (indata["n_veto_ele"] .== 0) .* (indata["n_veto_mu"] .== 0) .* (indata["n_signal_ele"] .== 0) .* (indata["n_signal_mu"] .== 1),
        :ele => (indata["lepton_type"] .== 11) .* (indata["n_veto_ele"] .== 0) .* (indata["n_veto_mu"] .== 0) .* (indata["n_signal_ele"] .== 1) .* (indata["n_signal_mu"] .== 0),

...
from plots.common.util import PhysicsProcess
import MVA2.common
...
plot_def={
    ...
    'labloc': 'top-left',
    'elecut': cutlist['2j1t']*cutlist['presel_ele']*Cut('mva_BDT_all_mu_Mario>0.154'),
    'mucut': cutlist['2j1t']*cutlist['presel_mu']*Cut('mva_BDT_all_mu_Mario>0.154')
}

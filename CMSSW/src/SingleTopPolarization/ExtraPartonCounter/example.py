...
process.pat2pxlio=cms.EDAnalyzer('EDM2PXLIO',
    ...
    SelectEventsFromPath = cms.vstring("generation_step"),
    ...
    q2weights = cms.PSet(
        ...
        srcs=cms.VInputTag(
            cms.InputTag("q2weights","weights"),
            cms.InputTag("q2weights","pdf"),
            cms.InputTag("q2weights","alphas"),
            cms.InputTag("q2weights","qcdvertices")
        ),
        names = cms.vstring("q2_weights","q2_pdf","q2_alphas","q2_qcdvertices")
    )

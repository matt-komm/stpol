...
plot_defs['final_cosTheta_loose_metup']['elecut']=cutlist['2j1t']*cutlist['presel_ele']*Cut('%s>%f' % (mva_var['ele'],bdt['ele']['loose']))*Cut('met>50')
plot_defs['final_cosTheta_loose_metup']['mucut']=cutlist['2j1t']*cutlist['presel_mu']*Cut('%s>%f' % (mva_var['mu'],bdt['mu']['loose']))*Cut('mt_mu>55')

plot_defs['final_cosTheta_loose_metdown'] = cp(plot_defs['final_cosTheta_mva_loose'])
plot_defs['final_cosTheta_loose_metdown']['elecut']=cutlist['2j1t']*cutlist['presel_ele']*Cut('%s>%f' % (mva_var['ele'],bdt['ele']['loose']))*Cut('met>40')
plot_defs['final_cosTheta_loose_metdown']['mucut']=cutlist['2j1t']*cutlist['presel_mu']*Cut('%s>%f' % (mva_var['mu'],bdt['mu']['loose']))*Cut('mt_mu>45')

plot_defs['final_cosTheta_metup'] = cp(plot_defs['final_cosTheta_mva_loose'])
plot_defs['final_cosTheta_metup']['elecut']=cutlist['2j1t']*cutlist['presel_ele']*Cut('met>50')
plot_defs['final_cosTheta_metup']['mucut']=cutlist['2j1t']*cutlist['presel_mu']*Cut('mt_mu>55')

plot_defs['final_cosTheta_metdown'] = cp(plot_defs['final_cosTheta_mva_loose'])
plot_defs['final_cosTheta_metdown']['elecut']=cutlist['2j1t']*cutlist['presel_ele']*Cut('met>40')
plot_defs['final_cosTheta_metdown']['mucut']=cutlist['2j1t']*cutlist['presel_mu']*Cut('mt_mu>45')

...
// 7 14 zero
Double_t list_x[bin_x+1] = {-1., -0.395, 0., 0.1386, 0.3332, 0.5126, 0.6936,  1.};
Double_t list_y[bin_y+1] = {-1., -0.6966, -0.465, -0.274, -0.1144, 0., 0.1462, 0.258, 0.3616, 0.459, 0.551, 0.6412, 0.7316, 0.8302, 1.};
#endif
